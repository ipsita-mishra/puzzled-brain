...
public class Controller {
	...
	public String landing(Model model) {
		...
		String para = "Welcome to Webber!! Webber has been created with love using a library widely used in the organization. Please be informed that this application re-deploys every 15 mins.";
